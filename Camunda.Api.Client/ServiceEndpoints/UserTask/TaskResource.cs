...
namespace Camunda.Api.Client.ServiceEndpoints.UserTask
{
    public class TaskResource
    {
        ...
        /// </remarks>
        public Task<Dictionary<string, VariableValue>> SubmitForm(CompleteTask completeTask) => _api.SubmitFormTask(_taskId, completeTask);
        ...
        /// </summary>
        public Task<Dictionary<string, VariableValue>> Complete(CompleteTask completeTask) => _api.CompleteTask(_taskId, completeTask);
